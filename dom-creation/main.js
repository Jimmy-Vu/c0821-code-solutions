...
function renderPokemon(pokemon) {
  ...
  columnThirdDiv.appendChild(pokemonCard);
  ...
  var pokemonNameText = document.createTextNode(pokemon.name);
  pokemonName.appendChild(pokemonNameText);
  pokemonText.appendChild(pokemonName);

  var pokemonNumber = document.createElement('h3');
  var pokemonNumberText = document.createTextNode('#' + pokemon.number);
  pokemonNumber.appendChild(pokemonNumberText);
  pokemonText.appendChild(pokemonNumber);

  var pokemonInfo = document.createElement('p');
  var pokemonInfoText = document.createTextNode(pokemon.description);
  pokemonInfo.appendChild(pokemonInfoText);
  pokemonText.appendChild(pokemonInfo);
